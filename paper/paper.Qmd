...
![Data, group means, and 95% confidence intervals for H5-shared, interaction of shared values and participant values.  Panels correspond to participant values.](`r here(out_dir, '03_shared_part.png')`){#fig-shared-part}
